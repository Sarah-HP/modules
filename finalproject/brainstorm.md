...
Leave a note in your project group's Slack channel with an idea for a dataset and/or visualization that you find interesting. Brainstorm together in your group's Slack channel (or in person if your group choses to meet up) so that when you come to class next week, you at least have some ideas bouncing around. At this stage groups should not be deciding anything, just tossing ideas out there and converging on a general theme that all the members would be interested in.
